...
const Loader = ({
  ...
  const styles = paletteStyles(palettes.palette, screen, offset, centre);

  const loadingScreenImage = (num) => {
    const image1 = <Image style={styles.joinImg} source={require('../../assets/spares.png')} />;
    const image2 = <Image style={styles.joinImg} source={require('../../assets/spares.png')} />;
    const image3 = <Image style={styles.joinImg} source={require('../../assets/spares.png')} />;
    const image4 = <Image style={styles.joinImg} source={require('../../assets/spares.png')} />;
    if (num === 4) {
      return image4;
    }
    if (num === 3) {
